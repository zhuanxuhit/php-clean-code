...
@section('content')
    ...
    <form role="form" action="" method="post">
        ...
        <div class="form-group">
            ...
            @include('validation-errors', ['name' => 'orderNumber', 'errors' => isset($errors) ? $errors : []])
        </div>
        <div class="form-group">
            ...
            @include('validation-errors', ['name' => 'description', 'errors' => isset($errors) ? $errors : []])
        </div>
        <div class="form-group">
            ...
            @include('validation-errors', ['name' => 'total', 'errors' => isset($errors) ? $errors : []])
        </div>
